// @ts-nocheck
/**
 * Verifications API Types
 *
 * API contract types come from @veritrace/core.
 * This file contains ONLY re-exports - no local API contract definitions.
 */

// ============================================================================
// API Type Re-exports (from @veritrace/core)
// ============================================================================
...
export type {
  // Add types from @veritrace/core/verifications
} from "@veritrace/core";

// Re-export with alias for backward compatibility if needed
// export type CoreVerificationsItem = VerificationsItem;
