...
const rawIdentityService = {
   ...
   */
  async getApiKey(params?: Record<string, any>, signal?: AbortSignal): Promise<any> {
    const url = `/v0/tenants/me/api-keys` + (params ? `?${new URLSearchParams(params).toString()}` : '');
   ...
   */
  async createApiKey(data?: any, signal?: AbortSignal): Promise<any> {
   ...
   */
  async getApiKey(keyId: string, params?: Record<string, any>, signal?: AbortSignal): Promise<any> {
    const url = `/v0/tenants/me/api-keys/${keyId}` + (params ? `?${new URLSearchParams(params).toString()}` : '');
   ...
   */
  async getUser(params?: Record<string, any>, signal?: AbortSignal): Promise<any> {
    const url = `/v0/tenants/me/users` + (params ? `?${new URLSearchParams(params).toString()}` : '');
   ...
   */
  async createUser(data?: any, signal?: AbortSignal): Promise<any> {
   ...
   */
  async getUser(userId: string, params?: Record<string, any>, signal?: AbortSignal): Promise<any> {
    const url = `/v0/tenants/me/users/${userId}` + (params ? `?${new URLSearchParams(params).toString()}` : '');
   ...
   */
  async updateUser(userId: string, data?: any, signal?: AbortSignal): Promise<any> {
   ...
   */
  async updateDisable(userId: string, data?: any, signal?: AbortSignal): Promise<any> {
   ...
   */
  async updateEnable(userId: string, data?: any, signal?: AbortSignal): Promise<any> {
   ...
   * Operator login (stub)
   */
  async getLogin(data?: any, signal?: AbortSignal): Promise<any> {
   ...
   */
  async getMe(params?: Record<string, any>, signal?: AbortSignal): Promise<any> {
    const url = `/v0/auth/me` + (params ? `?${new URLSearchParams(params).toString()}` : '');
   ...
   */
  async updateMe(data?: any, signal?: AbortSignal): Promise<any> {
   ...
   */
  async getRefresh(data?: any, signal?: AbortSignal): Promise<any> {
   ...
   */
  async getLogout(data?: any, signal?: AbortSignal): Promise<any> {
