...
const DOMAIN_PATH_PATTERNS: Array<{ pattern: RegExp; domain: string }> = [
  ...
  { pattern: /\/adapters\//, domain: "adapters" },
  { pattern: /\/blocks\//, domain: "blocks" },
  { pattern: /\/commitments\//, domain: "commitments" },
  { pattern: /\/consents\//, domain: "consents" },
  { pattern: /\/exports\//, domain: "exports" },
  { pattern: /\/identity\//, domain: "identity" },
  { pattern: /\/spaces\//, domain: "spaces" },
  { pattern: /\/verifications\//, domain: "verifications" },
];
...
export async function injectDomainDependencies(
  ...
  if (!domainDeps) {
    ...
    switch (domain) {
      case "adapters":
        domainDeps = buildAdaptersDomainModule(dynamoClient);
        break;
      case "blocks":
        domainDeps = buildBlocksDomainModule(dynamoClient);
        break;
      case "commitments":
        domainDeps = buildCommitmentsDomainModule(dynamoClient);
        break;
      case "consents":
        domainDeps = buildConsentsDomainModule(dynamoClient);
        break;
      case "exports":
        domainDeps = buildExportsDomainModule(dynamoClient);
        break;
      case "identity":
        domainDeps = buildIdentityDomainModule(dynamoClient);
        break;
      case "spaces":
        domainDeps = buildSpacesDomainModule(dynamoClient);
        break;
      case "verifications":
        domainDeps = buildVerificationsDomainModule(dynamoClient);
        break;
      default:
        return;
    }
...
export interface DomainDependencies {
  adapters: AdaptersDomainModule;
  blocks: BlocksDomainModule;
  commitments: CommitmentsDomainModule;
  consents: ConsentsDomainModule;
  exports: ExportsDomainModule;
  identity: IdentityDomainModule;
  spaces: SpacesDomainModule;
  verifications: VerificationsDomainModule;
}
 ...
 */
export function getAdaptersDeps(
  request: FastifyRequest,
): DomainDependencies["adapters"] {
  return getDomainDeps(request, "adapters");
}
export function getBlocksDeps(
  request: FastifyRequest,
): DomainDependencies["blocks"] {
  return getDomainDeps(request, "blocks");
}
export function getCommitmentsDeps(
  request: FastifyRequest,
): DomainDependencies["commitments"] {
  return getDomainDeps(request, "commitments");
}
...
export function getExportsDeps(
  request: FastifyRequest,
): DomainDependencies["exports"] {
  return getDomainDeps(request, "exports");
}
...
export function getSpacesDeps(
  request: FastifyRequest,
): DomainDependencies["spaces"] {
  return getDomainDeps(request, "spaces");
}
export function getVerificationsDeps(
  request: FastifyRequest,
): DomainDependencies["verifications"] {
  return getDomainDeps(request, "verifications");
}
