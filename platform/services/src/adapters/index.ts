/**
 * Adapters Services - Application Layer Export
 *
...
/**
 * Adapters Services - Application Layer
 *
 * DDD: Application use cases, ports, DTOs, policies, and errors for adapters domain.
 */
