/**
 * Verifications Services - Application Layer Export
 *
...
/**
 * Verifications Services - Application Layer
 *
 * DDD: Application use cases, ports, DTOs, policies, and errors for verifications domain.
 */
