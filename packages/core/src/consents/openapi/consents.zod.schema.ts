...
const ConsentGrantStatus = z.enum(['active', 'revoked', 'expired']);
const Problem = z
  .object({
    type: z.string().url(),
    title: z.string(),
...
const AccessRequestId = z.string();
...
const ConsentGrantResponse = z
  ...
  .passthrough();
const AccessRequestStatus = z.enum(['pending', 'granted', 'denied', 'expired']);
...
const AccessRequestListData = z
  ...
  .passthrough();
const AccessRequestListResponse = z
  .object({
    data: z
      .object({
        items: z.array(
